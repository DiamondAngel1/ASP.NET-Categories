...
{
    [Display(Name = "Прізвище")]// Підпис для поля у формі
    [Required(ErrorMessage = "Вкажіть прізвище")]// Валідація: обовязкове поле
    ...
    [Required(ErrorMessage = "Це поле обов'язкове!")]
    [Compare("Password", ErrorMessage = "Паролі не співпадають")]// Перевірка паролів чи вони співпадають
